...
export async function POST(req: Request) {
  try {
    ...
    const { prompt, amount = 1, resolution = "512x512" } = body; // if values not provided during POST request, then these default values will be used except prompt where we haven't given any default value
